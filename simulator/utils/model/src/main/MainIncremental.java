...
public class MainIncremental {
    ...
    public class SchedulingWithDiffN {
        ...
        public static void writeNodeConfigCSV(List<MainIncremental.NodeConfig> nodes, String path) throws Exception {
            ...
            // rows
            for (MainIncremental.NodeConfig n : nodes) {
                writer.write(
                        n.bandwidth + "," +
                                n.computationNodes + "," +
                                n.energyConsumption + "," +
        ...
        public static SchedulingResult runScheduler(List<MainIncremental.Job>  jobs,int nb_nodes, int nb_data, int[] data_sizes, int[][] works, int[] bandwidths, double[] cpus, int[] storage_capacity, double[] starting_times, int[][]  replicas_location, Model[] models, int pos, boolean solve, double[] job_arriving_times) {
